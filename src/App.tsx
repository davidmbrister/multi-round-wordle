...
import { SingleWinModal } from './components/modals/SingleWinModal'
...
function App() {
  ...
  const [guesses, setGuesses] = useState<string[]>(() => {
    ...
    if (loaded?.currentSolution !== currentSolution) {
      return []
    }
  ...
  useEffect(() => {
    saveGameStateToLocalStorage({ guesses, currentSolution })
  ...
  return (
    <div className="py-8 max-w-7xl mx-auto sm:px-6 lg:px-8">
      ...
      <SingleWinModal
        solution={currentSolution}
        isOpen={isSingleWinModalOpen}
        handleClose={() => setIsWinModalOpen(false)}
        guesses={guesses}
        handleLoadNext={() => {
          setIsSingleGameWon(false)
...
function refreshWordAndGuesses() {
  return []
}
